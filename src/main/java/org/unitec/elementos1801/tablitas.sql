...
create table direccion(id integer primary key auto_increment, calle varchar(100),cp integer, municipio varchar(40), ucuenta integer, foreign key (ucuenta) references usuario(cuenta));
